...
import { LocalApiService, Boost } from '../../../../../services/local-api.service';
...
@Component({
    selector: 'app-boost',
    imports: [NgOptimizedImage, DecimalPipe, BottomNavComponent, BalanceComponent, GlassSheetComponent],
    ...
    boosts = computed(() => {
        ...
        return apiBoosts
            ...
            .map(b => ({
                ...
                amount: b.amount,
                type: b.type,
                icon: b.icon ?? 'energy/thunder.png',
            }));
    });
