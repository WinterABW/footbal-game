...
import { LocalApiService, Transaction } from '../../services/local-api.service';
import { SupportChatComponent } from './support-chat.component';
import { BalanceWalletComponent } from '../../shared/balance-wallet/balance-wallet.component';
      ...
      <div class="flex-1 w-full relative z-10 flex flex-col overflow-y-auto no-scrollbar pt-safe-top pb-24 px-5 gap-2">
        ...
        <div class="flex flex-col items-center py-0 -mb-1.5">
          <div class="relative w-32 h-32 group">
            ...
            <img ngSrc="wallet/wallet-main.png" alt="wallet icon" width="128" height="128"
                ...
                <article (click)="onSheetItemClick(item)"
                  ...
                  <div class="flex items-center gap-3">
                    <div class="w-14 h-14 flex-shrink-0 rounded-xl overflow-hidden">
                      <img ngSrc="{{ item.icon }}" alt="{{ item.title }}" width="80" height="80" class="w-full h-full object-contain scale-125 group-hover:scale-150 transition-all">
                    </div>
                    <div>
