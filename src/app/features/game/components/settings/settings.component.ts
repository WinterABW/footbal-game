    ...
    <app-glass-modal [isOpen]="isOpen()" [compact]="true" (closed)="onClose()">
      <div class="flex flex-col gap-4">
        ...
        <main class="flex flex-col gap-2.5">
          ...
          <!-- 5. Canal de Telegram -->
          <a href="https://t.me/FifaEmpireGame" target="_blank" class="flex items-center gap-4 p-3 liquid-glass-card bg-white/[0.03] border-white/5 hover:bg-white/[0.06] active:scale-[0.98] transition-all w-full text-left no-underline rounded-2xl">
