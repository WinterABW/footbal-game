  ...
  template: `
    <nav class="flex justify-between items-center gap-3 px-1 py-1 z-20 relative">
      <div routerLink="/main/ruleta"
        ...
        <img ngSrc="shared/icons/lucky.png" alt="Billetera" class="w-12 h-12 object-contain opacity-80 group-hover:opacity-100 group-hover:scale-110 drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] group-hover:drop-shadow-[0_0_10px_rgba(250,204,21,0.6)] transition-all duration-300" width="48" height="48">
        <span class="text-[10px] font-black text-white/50 group-hover:text-yellow-400 uppercase tracking-widest transition-colors duration-300 mb-0.5 mt-0.5 text-glow-yellow">Lucky Spin</span>
      </div>
      ...
      <div routerLink="/main/box"
        ...
        <img ngSrc="mini-games/box/init.webp" alt="Misiones" class="w-12 h-12 object-contain opacity-80 group-hover:opacity-100 group-hover:scale-110 drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] group-hover:drop-shadow-[0_0_10px_rgba(217,70,239,0.6)] transition-all duration-300" width="48" height="48">
        <span class="text-[10px] font-black text-white/50 group-hover:text-fuchsia-400 uppercase tracking-widest transition-colors duration-300 mb-0.5 mt-0.5 text-glow-fuchsia">Open Box</span>
      </div>
      ...
      <div routerLink="/main/ticket"
        ...
        <img ngSrc="mini-games/tickets/tickets.webp" alt="Jugadores" class="w-12 h-12 object-contain opacity-80 group-hover:opacity-100 group-hover:scale-110 drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] group-hover:drop-shadow-[0_0_10px_rgba(34,211,238,0.6)] transition-all duration-300" width="48" height="48">
        <span class="text-[10px] font-black text-white/50 group-hover:text-cyan-400 uppercase tracking-widest transition-colors duration-300 mb-0.5 mt-0.5 text-glow-cyan">Tickets</span>
      </div>
    </nav>
  `,
  styles: [`
