  ...
  template: `
    <nav class="flex justify-between items-center gap-3 px-1 py-1 z-20 relative">
      <div routerLink="/main/ruleta"
        ...
        <span class="text-[10px] font-black text-white/50 group-hover:text-yellow-400 uppercase tracking-widest transition-colors duration-300 mb-0.5 mt-0.5">Lucky Spin</span>
      </div>
      ...
      <div routerLink="/main/box"
        ...
        <span class="text-[10px] font-black text-white/50 group-hover:text-fuchsia-400 uppercase tracking-widest transition-colors duration-300 mb-0.5 mt-0.5">Open Box</span>
      </div>
      ...
      <div routerLink="/main/ticket"
        ...
        <span class="text-[10px] font-black text-white/50 group-hover:text-cyan-400 uppercase tracking-widest transition-colors duration-300 mb-0.5 mt-0.5">Tickets</span>
      </div>
    </nav>
  `,
  styles: [`
