...
@Component({
  ...
  template: `
    <div class="flex items-center gap-1.5 py-1.5 px-3.5 rounded-full liquid-glass-card border-emerald-500/30 shadow-lg transition-all active:scale-95 cursor-default h-[44px] accent-emerald">
      ...
      <span class="text-[16px] font-black text-emerald-400 tracking-tight uppercase leading-none text-glow-emerald">
        {{ formattedEarning() }}<span class="text-[11px] text-white/40 ml-0.5">/h</span>
      </span>
    </div>
  `,
  styles: [`
