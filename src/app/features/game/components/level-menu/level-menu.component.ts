      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="flex items-center justify-between mb-3 pb-3 border-b border-white/5">
           <div class="flex items-center gap-2">
              <div class="relative">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center relative z-10 shadow-2xl">
                  <span class="text-xl font-black text-white text-glow">{{ levelInfo().level }}</span>
                </div>
        ...
        <main class="space-y-3">
          ...
          @if (!levelInfo().isMaxLevel) {
            <div class="liquid-glass-card p-4 bg-white/[0.02] border-white/5 flex flex-col gap-3">
               <div class="flex justify-between items-center">
                  <span class="text-[10px] font-black text-white/40 uppercase tracking-widest">Progreso de Carrera</span>
                  <span class="text-[10px] font-black text-indigo-400 uppercase tracking-widest">{{ ((levelInfo().currentTaps / levelInfo().tapsForNextLevel) * 100) | number:'1.0-0' }}%</span>
               </div>
