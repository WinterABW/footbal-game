...
import type { EnergyState, Boost, ActiveBoost, TapConfig, EarningSource, GameState } from '../../models/game.model';
import type { Transaction, DepositMethod, CryptoAddress } from '../../models/transaction.model';
...
const CRYPTO_ADDRESSES: CryptoAddress[] = [
    { currency: 'USDT', network: 'TRC-20', address: 'Anwu61627kqjejbqik1872jqnz&1727bwjduuiq1827jwjs', qrCode: 'wallet/crypto/USDT/trc.PNG' },
    { currency: 'USDT', network: 'BEP-20', address: 'Anwu61627kqjejbqik1872jqnz&1727bwjduuiq1827jwjs', qrCode: 'wallet/crypto/USDT/bep.PNG' },
    { currency: 'USDT', network: 'ERC-20', address: 'Anwu61627kqjejbqik1872jqnz&1727bwjduuiq1827jwjs', qrCode: 'wallet/crypto/USDT/erc.PNG' },
    { currency: 'BTC', address: 'Anwu61627kqjejbqik1872jqnz&1727bwjduuiq1827jwjs', qrCode: 'wallet/crypto/btc-qr.png' },
    { currency: 'TRX', address: 'Anwu61627kqjejbqik1872jqnz&1727bwjduuiq1827jwjs', qrCode: 'wallet/crypto/trx-qr.png' },
    { currency: 'BNB', address: 'Anwu61627kqjejbqik1872jqnz&1727bwjduuiq1827jwjs', qrCode: 'wallet/crypto/bnb-qr.png' },
];
...
const DEFAULT_PLAYERS: PlayersData = {
    availablePlayers: [
        { id: 1, name: 'Ronaldo CR7', price: 500, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'Leyenda del fútbol', earning: 15, level: 1, contract_days: 19, age: 39, injuries: 0, height: 187 },
        { id: 2, name: 'Messi', price: 600, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'El mejor del mundo', earning: 15, level: 1, contract_days: 19, age: 37, injuries: 0, height: 170 },
        { id: 3, name: 'Neymar Jr', price: 700, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'Magia brasileña', earning: 15, level: 2, contract_days: 19, age: 33, injuries: 1, height: 175 },
        { id: 4, name: 'Mbappé', price: 800, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'Velocidad pura', earning: 15, level: 2, contract_days: 19, age: 25, injuries: 0, height: 178 },
        { id: 5, name: 'Haaland', price: 900, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'Goleador nato', earning: 15, level: 3, contract_days: 19, age: 24, injuries: 0, height: 194 },
        { id: 6, name: 'Vinicius Jr', price: 1000, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'Futuro del fútbol', earning: 15, level: 3, contract_days: 19, age: 23, injuries: 0, height: 176 },
    ],
    vipPlayers: [
        { id: 101, name: 'Messi VIP', price: 2000, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'Edición legendaria', earning: 100, level: 5, exclusive: true, contract_days: 19, age: 37, injuries: 0, height: 170 },
        { id: 102, name: 'CR7 VIP', price: 2500, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'El comandante', earning: 100, level: 5, exclusive: true, contract_days: 19, age: 39, injuries: 0, height: 187 },
        { id: 103, name: 'Mbappé VIP', price: 3000, imageUrl: 'invest/players/image-removebg-preview.webp', description: 'Estrella exclusiva', earning: 100, level: 6, exclusive: true, contract_days: 19, age: 25, injuries: 0, height: 178 },
    ],
    ownedPlayers: [],
};
